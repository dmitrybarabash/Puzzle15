...
namespace Puzzle15.Wpf.ViewModels
{
    public class MainWindowViewModel : BaseViewModel
    {
        ...
        public MainWindowViewModel()
        {
            NewGameCommand = new DelegateCommand(win =>
            {
                ...
                //var mainWindow = Application.Current.MainWindow as Puzzle15.Wpf.Views.MainWindow;
                var mainWindow = win as Puzzle15.Wpf.Views.MainWindow;
